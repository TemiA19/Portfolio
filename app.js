...
const helloTextContainer = document.querySelector(".helloTextContainer")
const helloImgContainer = document.querySelector(".helloImgContainer")
const authorName = document.querySelector(".name")
const descTitleContainers = document.querySelectorAll(".descTitleContainer")
const descTitles = document.querySelectorAll(".descTitle")
...
window.addEventListener("scroll", ()=>{
    ...
    helloTextContainer.style.transform= `translateY(${offsetY * 0.1}px)`
    helloImgContainer.style.transform= `translate(${offsetY * 0.4}px, ${offsetY * 0.7}px)`
    authorName.style.transform= `translateX(${offsetY * 0.1}px)`
    descTitleContainers[0].style.backgroundPositionY = `${offsetY * 0.5}px`
    descTitleContainers[1].style.backgroundPositionY = `${-offsetY * 0.5}px`
    descTitles[0].style.transform = `translateX(calc(200vh - ${offsetY}px))`
    descTitles[1].style.transform = `translateX(calc(-300vh + ${offsetY}px))`
